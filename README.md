...
and REF 012378 breakouts, are collectively referred to as Connex herein. Either breakout works with either base. The bases are functionally identical, as are 
the breakouts. 
